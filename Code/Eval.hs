...
eval vars fs (Concat a b) = case (eval vars fs a, eval vars fs b) of
                                ...
                                _ -> Left $ ValueError "Cannot concatenate given values"
...
eval vars fs (Sqrt a) = do
    ...
    case val of
        ...
        _ -> Left $ MathError "Cannot calculate square root of given value"
...
eval vars fs (ToFloat e) = do
    ...
    case value of
        StrVal s -> case readMaybe s of
                        ...
                        Nothing -> Left (ValueError "Cannot convert given value to float")
        IntVal i -> Right (FloatVal (fromIntegral i))
        FloatVal f -> Right (FloatVal f)
        _ -> Left $ ValueError "Cannot convert given value to float"
